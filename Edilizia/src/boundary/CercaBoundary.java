...
public class CercaBoundary {
  ...
  //Cliccando su "Aggiungi" si inserisce una riga nella tabella delle attrezzature
    @FXML
    protected void aggiungiAttrezzatura(ActionEvent event) {
    	...
    	for (Attrezzatura attr : tv_attr.getItems()){
    		//Se inserisco un'attrezzatura uguale ad una già inserita mando un Alert
    ...
    //Cliccando "Crea/Modifica Modello" si passa all'interfaccia di modifica modello
    @FXML
    ...
    //Cliccando "Crea/Modifica Stanza" si passa all'interfaccia di modifica stanza
    @FXML
