...
public class StanzaController {
	...
	public static boolean cercaStanza(String nomeStanza) throws SQLException, ClassNotFoundException {
		if (StanzaDAO.getInstance().cercaStanza(nomeStanza) == null){
			//se ha restituito null la stanza non esiste quindi può essere creata
			return true;
		}
			return false;
	}
	...
	public static ObservableList<AttrezzaturaStanza> estraiAttrStanza(String stanzaImp) throws ClassNotFoundException, SQLException {
	...
	public static void salvaStanza(String stanza,String edificio, String piano, String tipo, ObservableList<AttrezzaturaStanza> attrSt) throws ClassNotFoundException, SQLException {
		AttrezzaturaStanzaDAO.getInstance().salvaStanza(stanza, attrSt);	
		StanzaDAO.getInstance().salvaStanza(stanza, edificio, piano, tipo);
	}

	public static void aggiornaStanza(String stanza, ObservableList<AttrezzaturaStanza> attrSt) throws ClassNotFoundException, SQLException {
